...
// Shared with auto_updater.cpp (included below) and the plugin .cpp handler.
#ifndef FLUTTER_AUTO_UPDATER_WIN_EVENT_MSG
#define FLUTTER_AUTO_UPDATER_WIN_EVENT_MSG (WM_APP + 0x5143)
#endif
